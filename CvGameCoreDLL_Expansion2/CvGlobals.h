...
#ifdef EA_RENOUNCE_MALEFICIUM_VALUE_DEFINES		// Paz - AI valuation settings for this trade item

	inline int getAI_RENOUNCE_MALEFICIUM_BASE_VALUE()
	{
		return m_iAI_RENOUNCE_MALEFICIUM_BASE_VALUE;
	}
	inline int getAI_RENOUNCE_MALEFICIUM_PEACE_MULTIPLIER()
	{
		return m_iAI_RENOUNCE_MALEFICIUM_PEACE_MULTIPLIER;
	}
	inline int getAI_RENOUNCE_MALEFICIUM_RECEIVER_VALUE()
	{
		return m_iAI_RENOUNCE_MALEFICIUM_RECEIVER_VALUE;
	}
...
#ifdef EA_RENOUNCE_MALEFICIUM_VALUE_DEFINES		// Paz - AI valuation settings for this trade item
	int m_iAI_RENOUNCE_MALEFICIUM_BASE_VALUE;
	int m_iAI_RENOUNCE_MALEFICIUM_PEACE_MULTIPLIER;
	int m_iAI_RENOUNCE_MALEFICIUM_RECEIVER_VALUE;
#endif
